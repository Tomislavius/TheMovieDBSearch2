...
public class MoviesUpcomingFragment extends BaseFragment implements MoviesRecyclerViewAdapter.LoadMoreCallback,
    ...
    private void loadMovies() {
        ...
        service.getUpcomingMoviesResult(BuildConfig.API_KEY, page).enqueue(new Callback<Movies>() {
            @Override
