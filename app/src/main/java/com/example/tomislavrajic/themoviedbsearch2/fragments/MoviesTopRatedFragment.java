...
public class MoviesTopRatedFragment extends MoviesBaseFragment {

    @Override
    protected void loadMovies() {
        TheMovieDBAPI service = ServiceGenerator.createService(TheMovieDBAPI.class);

        service.getTopRatedMoviesResult(BuildConfig.API_KEY, page).enqueue(new Callback<TMDBResponseData>() {
            @Override
